...
<div className='bg-white rounded-2xl 
 ...
 w-full max-w-96 mx-auto mt-9 overflow-hidden'>
    ...
    <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-4  p-4' >
     ...
     ' htmlFor='email'>Ingresar correo</label>
     <input {...register('email')} type='email' 
     className=' shadow-lg font-bold focus:border-[#7C7C7C]   text-[#7C7C7C]
      text-sm text-center    border-2  rounded-xl  ' id='email' />
      </div>
     ...
     '  htmlFor='password'>Contraseña</label>
      ...
      text-sm text-center  border-solid border-2  rounded-xl 
           outline-none
           focus:border-[#7C7C7C]' id='password' type='password' />
     </div>   
      <button type='submit' className='font-bold shadow-lg cursor-pointer w-[130px] h-[45px] bg-[#055286]
