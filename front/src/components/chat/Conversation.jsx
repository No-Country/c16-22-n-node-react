...
function Conversation() {
  ...
  return (
    <div className="w-3/4 text-white">
      ...
      <div className=" w-full h-[90%] p-10 bg-[#E0E9EE] flex flex-col space-y-6 justify-end">
        {/* our chat */}
        ...
        <div className="self-center">
          <input className=" w-[540px] h-[53px] rounded-xl" type="text" placeholder="Escribi aca tu respuesta" />
          <button className=" ml-5 w-[146px] rounded-2xl p-3 text-black bg-accent">Responder</button>
        </div>
      </div>
    </div>
  );
